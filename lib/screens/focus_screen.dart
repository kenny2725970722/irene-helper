...
class _FocusScreenState extends State<FocusScreen>
  ...
  SoundType _selectedSound = SoundType.none;
  bool _isWithered = false;
  DateTime? _backgroundedAt;

  double get _growth {
    if (_isWithered) return 0.0;
    if (!_isFocusMode) return 1.0;
              ...
              AnimatedSwitcher(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(color: themeColor.withAlpha(80), width: 2),
                  ),
                  child: Text(
